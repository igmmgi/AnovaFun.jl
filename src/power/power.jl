...
function _power_simulation(
    ...
    for i = 1:nrow(first_result.table)
            ...
            task = Threads.@spawn begin
                ...
                try
                    ...
                    if compute_pairwise
                        ...
                        for (idx, (pw_row, sim_row)) in enumerate(
                            zip(eachrow(first_pw_result.table), eachrow(pw.table)),
                        )
...
"""
function _run_anova_on_sim_data(
    data::DataFrame,
    between_factors::Vector{Symbol},
    within_factors::Vector{Symbol},
)
